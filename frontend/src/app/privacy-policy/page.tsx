...
export default function PrivacyPolicyPage() {
  ...
  const title = t("legal", "privacyPolicyTitle");
  const updated = t("legal", "lastUpdated");
  const intro = t("legal", "privacyPolicyIntro");
  const body = t("legal", "privacyPolicyBody");
      ...
      <main className={cn("pt-16", isRTL ? "lg:pr-64" : "lg:pl-64")}>
        <div className="max-w-2xl mx-auto p-4 space-y-4">
          <div className="flex items-center justify-between gap-3">
            ...
            <Link href="/terms-of-service" className="text-sm text-primary-600 hover:underline">
              {t("legal", "viewTerms")}
            </Link>
          </div>
