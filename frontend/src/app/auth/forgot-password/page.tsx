      ...
      <div className={`w-full lg:w-1/2 xl:w-2/5 flex items-center justify-center p-4 sm:p-8 bg-(--bg) ${isRTL ? "order-1" : "order-2"}`}>
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden text-center mb-8">
            ...
            <p className="text-(--text-muted) mt-2">{t("auth", "forgotPasswordTitle")}</p>
          </div>
            ...
            {!isSuccess ? (
              <>
                <div className="text-center mb-6">
                  <h2 className="text-2xl font-bold text-(--text)">{t("auth", "forgotPasswordTitle")}</h2>
              ...
              <>
                ...
                <div className="text-center">
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      {isLoading ? t("auth", "sendingResetLink") : t("auth", "resendResetLink")}
                    </button>
                  </div>
