...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      >
        <div className="absolute inset-0 bg-linear-to-br from-primary-950 via-primary-800 to-primary-600" />
      ...
      <div
        className={`w-full lg:w-1/2 xl:w-2/5 flex items-center justify-center p-4 sm:p-8 bg-(--bg) ${
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-(--bg-card) rounded-2xl border border-(--border) shadow-xl p-6 sm:p-8">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className={`w-full py-2.5 rounded-lg border border-(--border) bg-(--bg) text-(--text) placeholder:text-(--text-muted) focus:outline-none focus:ring-2 focus:ring-primary-500 ${
              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button
                    ...
                    onClick={() => toast.error(t("auth", "adminOnly"))}
                  >
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className={`absolute top-1/2 -translate-y-1/2 text-(--text-muted) hover:text-(--text) ${
            ...
            <p className="text-center text-xs text-(--text-muted) mt-6">
              {t("auth", "termsAgreement")} <span className="text-primary-600">{t("auth", "termsOfService")}</span>{" "}
              {t("common", "and")} <span className="text-primary-600">{t("auth", "privacyPolicy")}</span>
            </p>
          </div>
        </div>
      </div>
